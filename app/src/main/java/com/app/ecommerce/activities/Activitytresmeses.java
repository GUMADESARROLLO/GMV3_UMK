...
import com.app.ecommerce.adapters.RecyclerAdapterFacturasLineas;
import com.app.ecommerce.adapters.RecyclerAdapterLast3M;
import com.app.ecommerce.models.Factura_lineas;
...
import static com.app.ecommerce.utilities.Constant.GET_DETALLE_FACTURA;
import static com.app.ecommerce.utilities.Constant.GET_LAST_3M;

public class Activitytresmeses extends AppCompatActivity {
    String cod_factura,name_text;

    private RecyclerAdapterLast3M mAdapter;
    ...
    private void initToolbar() {
        ...
        mAdapter = new RecyclerAdapterLast3M(this, productList);
