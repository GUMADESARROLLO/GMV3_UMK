...
public class RecyclerAdapterBnfc extends RecyclerView.Adapter<RecyclerAdapterBnfc.ViewHolder> {
    ...
    public RecyclerAdapterBnfc(Context context, List<String> arrayItemCart) {
