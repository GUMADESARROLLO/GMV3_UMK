...
public class RecyclerAdapterLstResumen extends RecyclerView.Adapter<RecyclerAdapterLstResumen.ViewHolder> {
    ...
    public RecyclerAdapterLstResumen(Context context, ArrayList<ArrayList<Object>>  arrayItemCart, String Moneda) {
