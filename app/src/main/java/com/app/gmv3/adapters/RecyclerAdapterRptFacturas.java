...
public class RecyclerAdapterRptFacturas extends RecyclerView.Adapter<RecyclerAdapterRptFacturas.ViewHolder> {
    ...
    public RecyclerAdapterRptFacturas(List<Reporte_Factura> arrayItemCart) {
