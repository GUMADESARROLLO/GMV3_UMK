...
import com.app.gmv3.adapters.AdapterCheckoutVineta;
...
public class ActivityCheckoutVineta extends AppCompatActivity {
    ...
    AdapterCheckoutVineta rcLista_Resumen;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checkout_vineta);
        ...
        requestQueue = Volley.newRequestQueue(ActivityCheckoutVineta.this);
        progressDialog = new ProgressDialog(ActivityCheckoutVineta.this);
        ...
        rcLista_Resumen = new AdapterCheckoutVineta(this, data);
        ...
        (findViewById(R.id.id_img_beneficiario)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showCustomDialog("Beneficiario");
            }
        });
    ...
    public void requestAction() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, POST_ORDER_VINETA, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("address", str_benific);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ActivityCheckoutVineta.this);
    ...
    public void getDataFromDatabase() {
        ...
        data = dbhelper.getAllDataVinete(str_cod_cliente);
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            String Linea_Factu  = row.get(8).toString();
            ...
            data_order_list += "[" + (Factura + ";" + Cod_Vineta + ";" + Cant_Vineta + ";" + Valor_und + ";" + Valor_total + ";" + Linea_Factu  + "],");
        }
        ...
        (dialog.findViewById(R.id.bt_add)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_cod_recibo.equals("")){
                    ...
                    txt_number_recibo.setText(str_cod_recibo);
                    dialog.dismiss();
                }
    ...
    public void dialogSuccessOrder() {
        ...
        (dialog.findViewById(R.id.bt_close)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = getIntent();
                dbhelper.deleteAllDataVineta(i.getStringExtra("cliente_codigo"));
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (form.equals("Observacion")){
                    ...
                    str_benific = et_post.getText().toString();
                    edt_address.setText(str_benific);
                }
